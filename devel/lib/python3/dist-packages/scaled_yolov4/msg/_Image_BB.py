...
"""autogenerated by genpy from scaled_yolov4/Image_BB.msg. Do not edit."""
import codecs
import sys
...
float32[] coordinates"""
  ...
  _slot_types = ['int16','scaled_yolov4/BB[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Image_BB, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.bb_number is None:
        self.bb_number = 0
      if self.bb_array is None:
        self.bb_array = []
    else:
      self.bb_number = 0
      self.bb_array = []
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.bb_number,) = _get_struct_h().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.bb_array = []
      for i in range(0, length):
        val1 = scaled_yolov4.msg.BB()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
